...
class Sub_Camera(Node):
    """
    Class: Sub_Camera
    Purpose: ROS2 Camera node, retrieves information from ROS2 Camera publishers
    ...
    def __init__(self):
        ...
        self.get_logger().info("UI-SUB-CAMERA || Status: Active")
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info("UI-SUB-CAMERA || Status: Inactive")
